...
import { JSAsciiTable } from "../libs/js-ascii-table";
// Local imports Utils
import { prefix } from "../config.json";
import { sendErrorToDev } from "../libs/utils";
// Local imports
import telialigaenTabellerGP from "../libs/telialigaen_tab_gp_await";
import tlKamper from "../libs/telialigaen_tab_team_next_match";
import { Message } from "discord.js";
import { ApplicationCommandInteractionDataOptionString } from "discord-api-types";
    ...
    if (
      ...
      if (args.length >= 2 && args[1].toUpperCase() == "GP") {
        telialigaenTabellerGP
          .main()
          .then(function (asciiTable: String) {
